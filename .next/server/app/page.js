...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.t.bind(__webpack_require__, 3428, 23)), "/Users/sara/Desktop/Sara/Startup/geteyeris/app/page.tsx"],
          
        }]
      },
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 729)), "/Users/sara/Desktop/Sara/Startup/geteyeris/app/layout.tsx"],
          
        }
      ]
      }.children;
    const pages = ["/Users/sara/Desktop/Sara/Startup/geteyeris/app/page.tsx"];
...
throw new Error("Module build failed (from ./node_modules/next/dist/build/webpack/loaders/next-swc-loader.js):\nError: \n  \u001b[38;2;255;30;30m×\u001b[0m NEXT_RSC_ERR_REACT_API: useState\n   ╭─[\u001b[38;2;92;157;255;1;4m/Users/sara/Desktop/Sara/Startup/geteyeris/app/page.tsx\u001b[0m:1:1]\n \u001b[2m1\u001b[0m │ import { useState } from 'react'\n   · \u001b[38;2;246;87;248m         ────────\u001b[0m\n \u001b[2m2\u001b[0m │ import { motion } from 'framer-motion'\n \u001b[2m3\u001b[0m │ import { ChevronRight, Menu } from 'lucide-react'\n \u001b[2m4\u001b[0m │ import Link from 'next/link'\n   ╰────\n");
...
var __webpack_exports__ = __webpack_require__.X(0, [534,182], () => (__webpack_exec__(6454)));
